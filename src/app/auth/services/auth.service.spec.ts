...
/* 
Mediante el describe, definimos las importaciones de nuestro caso de prueba
  ...
  it('El login debe funcionar', ( done ) => {
    ...
    const MOCK_REQUEST_RESULT: Usuario[] = [

      {
        ...
        role: 'admin',
        token: 'asdsadasasddsa456555455asdasd',
      },
    ...
    httpController
      .expectOne({
        ...
        url: `${enviroment.baseApiUrl}/usuarios?email=${loginFake.email}&password=${loginFake.password}`,
        method: 'GET',
      })
